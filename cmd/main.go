...
import (
	"binance-tss-mpc-server/cmd/tsshttp"
	"bufio"
	"flag"
	"fmt"
	"log"
...
func main() {
	...
	_ = golog.SetLogLevel("tsshttp-lib", "INFO")
...
func parseFlags() (tssConf common.TssConfig, p2pConf p2p.Config) {
	...
	flag.StringVar(&tssAddr, "tsshttp-port", "127.0.0.1:8080", "tsshttp port")
	...
	flag.BoolVar(&tssConf.EnableMonitor, "enablemonitor", true, "enable the tsshttp monitor")
