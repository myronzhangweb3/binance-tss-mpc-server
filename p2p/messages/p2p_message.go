...
const (
	// TSSKeyGenMsg is the message directly generated by tsshttp-lib package
	TSSKeyGenMsg THORChainTSSMessageType = iota
	// TSSKeySignMsg is the message directly generated by tsshttp lib for sign
	TSSKeySignMsg
...
// WireMessage the message that produced by tsshttp-lib package
